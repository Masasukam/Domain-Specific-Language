...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        try {
            HtmlLexer lexer = new HtmlLexer(CharStreams.fromFileName("input"));
            ...
            parsedProgram.evaluate(writer);
            writer.close();
            System.out.println("Done evaluation");
        } catch(Exception e){
            writer.close();
            writeErrorPage(new PrintWriter(new FileWriter("output.html")), e.getMessage());
        }
    }

    public static void writeErrorPage(PrintWriter writer, String message) {
        System.out.println("Writing error page.");
        System.out.println(message);
        String errorPageBeforeMsg = """
                <!DOCTYPE html>
                <html lang="en">
                <head>
                ...
                <div class="container">
                    <div class="left-section">
                        <div class="inner-content">
                            ...
                            <p class="subheading">An error occurred:</p>
                            <p class="subheading">
                            """;
        String errorPageAfterMsg = """
                </p>
                        </div>
                    </div>
                ...
                """;
        writer.println(errorPageBeforeMsg + message + errorPageAfterMsg);
        writer.close();
    }
